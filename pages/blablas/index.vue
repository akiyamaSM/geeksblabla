<template>
  <div class="container mx-auto flex-1 flex text-white font-sans text-xs">
    <div class="episodes w-2/5 h-128 overflow-scroll overflow-x-hidden mr-5">
      <div class="preview flex items-center opacity-50 hover:active-episode" :class="{'active-episode': index === 0}" v-for="(blabla, index) in blablas" :key="blabla.id" :id="blabla.slug">
        <div class="mr-2">
